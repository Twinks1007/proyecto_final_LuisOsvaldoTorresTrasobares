package com.dog.doggallery.ui.screens.components.doglist
                        ...
                        .fillMaxSize())
                {
                        Row(
                            ...
                            Image(
                                ...
                                colorFilter = if (dogsRoom.value?.find { r -> r.name == dogItem.name }?.favorite == true) ColorFilter.tint(Color.Yellow) else ColorFilter.tint(Color.Black)
                            )
                        }
                        Row(
                            modifier = Modifier
