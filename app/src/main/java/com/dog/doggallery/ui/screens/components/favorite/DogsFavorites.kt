package com.dog.doggallery.ui.screens.components.favorite
...
import com.dog.doggallery.ui.navigation.Routes
import com.dog.doggallery.ui.screens.components.doglist.DogListItem
import com.dog.doggallery.viewModel.ViewModelDog

@Composable
fun DogFavorite(navController: NavHostController, viewModelDog: ViewModelDog){
